...
namespace EnhancedScrollerDemos.GridSimulation
{
    ...
    /// </summary>
    public class CellViewGrid : EnhancedScrollerCellView
    {
        public RowCellViewGrid[] rowCellViews;

        /// <summary>
        /// This function just takes the Demo data and displays it
        /// </summary>
        /// <param name="data"></param>
        public void SetData(ref SmallList<DataGrid> data, int startingIndex)
        {
