...
namespace EnhancedScrollerDemos.GridSimulation
{
    ...
    public class ControllerGrid : MonoBehaviour, IEnhancedScrollerDelegate
    {
        /// <summary>
        /// Internal representation of our data. Note that the scroller will never see
        /// this, so it separates the data from the layout using MVC principles.
        /// </summary>
        private SmallList<DataGrid> _data;
        ...
        private void LoadData()
        {
            ...
            _data = new SmallList<DataGrid>();
            for (var i = 0; i < 1000; i ++)
            {
                _data.Add(new DataGrid() { someText = i.ToString() });
            }
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            CellViewGrid cellView = scroller.GetCellView(cellViewPrefab) as CellViewGrid;
